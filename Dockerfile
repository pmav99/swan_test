...
USER root
# https://github.com/FernandoMiguel/BuildKit/tree/ea6a016c6cfc26ec941bbd8919e33508695d66f3#mounttypecache
...
# We will also install the jupyter lab extensions
USER ${NB_UID}
RUN mamba install --quiet --yes \
    'jupyterlab<3'; \
    mamba clean --all -f -y; \
...
RUN --mount=type=cache,target=/home/"${NB_USER}"/.cache,rw \
